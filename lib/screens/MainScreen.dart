...
class _MainScreenState extends State<MainScreen> {
                ...
                return AppDrawer(
                  ...
                  child: Stack(
                    children: [
                      ...
                      buildSearchOverlay(size, context)
                    ],
                  ),
                );
              }),
  ...
  Container buildSearchBar(Size size) {
    return Container(
        height: 80,
        alignment: Alignment.center,
        child: GestureDetector(
          ...
          child: Container(
            ...
            margin: EdgeInsets.symmetric(horizontal: (isSearchMode ? 10 : 35)),
            decoration: BoxDecoration(borderRadius: BorderRadius.circular(30)),
          ),
        ));
  }

  IgnorePointer buildSearchOverlay(Size size, BuildContext context) {
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  ...
                                  if (_searchController.text.isNotEmpty) {
                                    if (allApps
                                        .where((element) =>
                                            element.package.contains('vanced'))
                                        .isNotEmpty) {
