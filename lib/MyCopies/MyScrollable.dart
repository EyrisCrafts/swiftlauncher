...
class MyScrollable extends StatefulWidget {
  ...
  /// See also:
  ///
  ///  * [AlwaysMyScrollableScrollPhysics], which can be used to indicate that the
  ///    MyScrollable should react to scroll requests (and possible overscroll)
  ///    even if the MyScrollable's contents fit without scrolling being necessary.
  final ScrollPhysics physics;

  /// Builds the viewport through which the MyScrollable content is displayed.
  ///
  ...
  /// scroll when the MyScrollable is asked to scroll via the keyboard using a
  /// [ScrollAction].
  ///
  ...
  static Future<void> ensureVisible(
    ...
    ScrollableState scrollable = MyScrollable.of(context);
...
class ScrollableState extends State<MyScrollable>
...
class ScrollAction extends Action<ScrollIntent> {
  ...
  void invoke(ScrollIntent intent) {
    final ScrollableState state = MyScrollable.of(primaryFocus.context);
    assert(state != null,
